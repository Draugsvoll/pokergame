...
(function() {
  ...
  endHand = function() {
    var amount, heroHand, heroHandStrength, villainHand, villainHandStrength;
    // show villain hand
...
// loop cards
  ...
  renderButtons = function(facingBet) {
    ...
    if (facingBet === 0) {
      ...
      return bet_raise_btn.innerHTML = 'Raise $' + (facingAmount + 100);
    }
  };
