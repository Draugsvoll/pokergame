...
(function() {
  ...
  dealCards = function() {
    ...
    return console.log('cards left: ', deck.length);
  };
  ...
  endHand = function() {
    var heroHand, heroHandStrength, villainHand, villainHandStrength;
    // show villain hand
    ...
    if (heroHandStrength > villainHandStrength) {
      return console.log('Hero wins with: ', heroHand);
    } else if (heroHandStrength < villainHandStrength) {
      return console.log('villain wins with: ', villainHand);
    } else {
      return console.log('Split pot with: ', heroHand);
    }
  };
...
// loop cards
  ...
  renderPot = function(amount) {
    return potDOM.innerHTML = '$' + amount;
  };
  ...
  renderButtons = function(facingBet) {
    ...
    if (facingBet === 0) {
      ...
      return bet_raise_btn.innerHTML = 'Bet';
    } else {
  ...
  renderDealerBtn = function(player) {
    if (player === 'hero') {
      ...
      return villain_dealer.src = '';
    } else {
      villain_dealer.src = 'assets/button.png';
      return hero_dealer.src = '';
    }
  };
  ...
  //###############
  villainAct = function() {
    var buttonBarShowAfterNextStreet, isVillainDealer, rand;
    renderStacks();
    button_bar.style.visibility = 'hidden';
      ...
      //#
        ...
        if (hero.getCurrentBet() === 0) {
          ...
          if (rand < 33) {
            ...
            // RAISE
            betAmount = hero.getCurrentBet() * villainCreateAndMakeBet(betAmount);
          }
        }
      //#
      // TURN #####################
